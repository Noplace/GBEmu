...
CONST	ENDS
CONST	SEGMENT
$SG129282 DB	'Code\emulation\gb\cartridge.cpp', 00H
CONST	ENDS
...
; 14   : void Cartridge::ReadFile(const char* filename, CartridgeHeader* header) {
...
; 15   :   core::io::DestroyFileBuffer(&rom_);
...
; 16   :   uint8_t* data;
; 17   :   size_t length;
; 18   :   core::io::ReadWholeFileBinary(filename,&data,length);
...
; 19   :   memcpy(header,data+0x100,0x50);
...
; 23   :   }
; 24   :   rom_ = new uint8_t[header->rom_size_bytes()];
...
; 25   :   memcpy(rom_,data,header->rom_size_bytes());
...
; 26   :   core::io::DestroyFileBuffer(&data);
...
; 27   : }
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN7@ReadFile
...
; 10   : void Cartridge::Deinitialize() {
...
; 11   :   core::io::DestroyFileBuffer(&rom_);

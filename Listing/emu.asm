...
CONST	ENDS
CONST	SEGMENT
$SG129270 DB	'Code\emulation\gb\emu.cpp', 00H
	ORG $+2
$SG129272 DB	'D:\Personal\Projects\GBEmu\test\cpu_instrs\cpu_instrs.gb'
	DB	00H
CONST	ENDS
...
EXTRN	?Step@Cpu@gb@emulation@@QAEXXZ:PROC		; emulation::gb::Cpu::Step
...
; 49   : 	cpu_.Step();
	...
	call	?Step@Cpu@gb@emulation@@QAEXXZ		; emulation::gb::Cpu::Step

; 50   : 	double r = dt*cpu_.cycles;
	...
	mov	eax, DWORD PTR tv77[ebp+4]
	mov	DWORD PTR tv80[ebp+4], eax
	and	DWORD PTR tv77[ebp+4], 2147483647	; 7fffffffH
	fild	QWORD PTR tv77[ebp]
	and	DWORD PTR tv80[ebp+4], -2147483648	; 80000000H
...
; 7    :   frame_buffer = new uint32_t[160*144];

	push	7
	push	OFFSET $SG129270
	push	1
...
; 8    :   emulation::gb::CartridgeHeader header;
; 9    :   cartridge_.Initialize(this);
...
; 10   :   
; 11   :   cartridge_.ReadFile("D:\\Personal\\Projects\\GBEmu\\test\\cpu_instrs\\cpu_instrs.gb",&header);
...
; 12   :   //cartridge_.ReadFile("D:\\Personal\\Projects\\GBEmu\\test\\Super Mario Land (World).gb",&header);
; 13   : 
; 14   :   memory_.Initialize(this);
...
; 16   :   /*uint32_t shades[4] = {0xffffffff,0xffaaaaaa,0xff666666,0xff000000};
; 17   :   for (int y=0;y<144;++y)
; 18   :   {
; 19   :     uint32_t *line = &output[y*160];
...
; 25   :   int logow = 9;
; 26   :   int logoh = 8;
; 27   :   for (int y=0;y<logoh;++y)
; 28   :   {
; 29   :     uint32_t *line = &output[y*160];
; 30   :     for (int x=0;x<logow;++x)
; 31   :     {
; 32   :       *line++ = shades[(header.nintendo_logo[y*logow+x]>>0)&0x3];
; 33   :       *line++ = shades[(header.nintendo_logo[y*logow+x]>>2)&0x3];
; 34   :       *line++ = shades[(header.nintendo_logo[y*logow+x]>>4)&0x3];
; 35   :       *line++ = shades[(header.nintendo_logo[y*logow+x]>>6)&0x3];
; 36   :     }
; 37   :   }*/
; 38   : }

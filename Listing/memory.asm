...
_dmgrom	DB	031H
	...
	DB	0e0H
	DB	050H
$SG129272 DB	'Code\emulation\gb\memory.cpp', 00H
	ORG $+3
$SG129275 DB	'Code\emulation\gb\memory.cpp', 00H
	ORG $+3
$SG129278 DB	'Code\emulation\gb\memory.cpp', 00H
	ORG $+3
$SG129281 DB	'Code\emulation\gb\memory.cpp', 00H
	ORG $+3
$SG129350 DB	'%c', 00H
CONST	ENDS
...
; 79   : void Memory::Write8(uint16_t address, uint8_t data) {
...
; 80   : 	if (address >= 0x0000 && address <= 0x3FFF) {
...
; 81   : 		//rom_[address];
; 82   : 	} else if (address >= 0x4000 && address <= 0x7FFF) {
...
; 83   : 		//return rom_[address];
; 84   : 	} else if (address >= 0x8000 && address <= 0x9FFF) {

	movzx	ecx, WORD PTR _address$[ebp]
	cmp	ecx, 32768				; 00008000H
	jl	SHORT $LN20@Write8
	movzx	edx, WORD PTR _address$[ebp]
	cmp	edx, 40959				; 00009fffH
	jg	SHORT $LN20@Write8
	jmp	$LN25@Write8
$LN20@Write8:

; 85   : 		//return vram_[address&0x1FFF];
; 86   : 	} else if (address >= 0xA000 && address <= 0xBFFF) {
...
; 87   : 		//return eram_[address&0x1FFF];
; 88   : 	} else if (address >= 0xC000 && address <= 0xCFFF) {
...
; 89   : 		//return wram1_[address&0x0FFF];
; 90   : 	} else if (address >= 0xD000 && address <= 0xDFFF) {
...
; 91   : 		//return wram2_[address&0x0FFF];
; 92   : 	} else if (address >= 0xE000 && address <= 0xFDFF) {
...
; 93   : 		//return wram1_[address-0xE000];
; 94   : 	} else if (address >= 0xFE00 && address <= 0xFE9F) {

	movzx	edx, WORD PTR _address$[ebp]
	cmp	edx, 65024				; 0000fe00H
	jl	SHORT $LN10@Write8
	movzx	eax, WORD PTR _address$[ebp]
	cmp	eax, 65183				; 0000fe9fH
	jg	SHORT $LN10@Write8
	jmp	SHORT $LN25@Write8
$LN10@Write8:

; 95   : 		//return oam_[address-0xFE00];
; 96   : 	} else if (address >= 0xFEA0 && address <= 0xFEFF) {
...
; 97   : 		//int a = 1;
; 98   : 	} else if (address >= 0xFF00 && address <= 0xFF7F) {
...
; 99   : 
; 100  : 		if (address == 0xFF01) {

	movzx	edx, WORD PTR _address$[ebp]
	cmp	edx, 65281				; 0000ff01H
	jne	SHORT $LN5@Write8

; 101  : 			char str[255];
; 102  : 			sprintf_s(str,"%c",data);

	movzx	eax, BYTE PTR _data$[ebp]
	push	eax
	push	OFFSET $SG129350
...
; 104  : 		}
; 105  : 
; 106  : 		ioports_[address-0xFF00]=data;
...
; 107  : 
; 108  : 	} else if (address >= 0xFF80 && address <= 0xFFFE) {
; 109  : 		//return hram_[address-0xFF80];
; 110  : 	} else if (address == 0xFFFF) {
; 111  : 		//return interrupt_enable_register_;
; 112  : 	}
; 113  : }
...
; 46   : uint8_t Memory::Read8(uint16_t address) {
...
; 48   : 		if (ioports_[0x50] == 0)
	...
	test	ecx, ecx
	jne	SHORT $LN24@Read8

; 49   : 			return dmgrom[address&0xFF];

	movzx	edx, WORD PTR _address$[ebp]
	and	edx, 255				; 000000ffH
	mov	al, BYTE PTR _dmgrom[edx]
	jmp	$LN26@Read8
...
; 52   : 	} else if (address >= 0x4000 && address <= 0x7FFF) {
...
; 54   : 	} else if (address >= 0x8000 && address <= 0x9FFF) {
...
; 55   : 		return vram_[address&0x1FFF];
...
; 56   : 	} else if (address >= 0xA000 && address <= 0xBFFF) {
...
; 57   : 		return eram_[address&0x1FFF];
...
; 58   : 	} else if (address >= 0xC000 && address <= 0xCFFF) {

	movzx	eax, WORD PTR _address$[ebp]
	cmp	eax, 49152				; 0000c000H
	jl	SHORT $LN15@Read8
	movzx	ecx, WORD PTR _address$[ebp]
	cmp	ecx, 53247				; 0000cfffH
	jg	SHORT $LN15@Read8

; 59   : 		return wram1_[address&0x0FFF];
...
; 60   : 	} else if (address >= 0xD000 && address <= 0xDFFF) {

	movzx	edx, WORD PTR _address$[ebp]
	cmp	edx, 53248				; 0000d000H
	jl	SHORT $LN13@Read8
	movzx	eax, WORD PTR _address$[ebp]
	cmp	eax, 57343				; 0000dfffH
	jg	SHORT $LN13@Read8

; 61   : 		return wram2_[address&0x0FFF];
...
; 62   : 	} else if (address >= 0xE000 && address <= 0xFDFF) {
...
; 63   : 		return wram1_[address-0xE000];

	movzx	eax, WORD PTR _address$[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+16]
	mov	al, BYTE PTR [edx+eax-57344]
	jmp	$LN26@Read8
	jmp	$LN22@Read8
$LN11@Read8:

; 64   : 	} else if (address >= 0xFE00 && address <= 0xFE9F) {
...
; 65   : 		return oam_[address-0xFE00];

	movzx	edx, WORD PTR _address$[ebp]
	mov	eax, DWORD PTR _this$[ebp]
	mov	al, BYTE PTR [eax+edx-65000]
	jmp	$LN26@Read8
	jmp	$LN22@Read8
$LN9@Read8:

; 66   : 	} else if (address >= 0xFEA0 && address <= 0xFEFF) {
...
; 67   : 		int a = 1;
	...
	jmp	SHORT $LN22@Read8
$LN7@Read8:

; 68   : 	} else if (address >= 0xFF00 && address <= 0xFF7F) {
...
; 69   : 		return ioports_[address-0xFF00];

	movzx	edx, WORD PTR _address$[ebp]
	mov	eax, DWORD PTR _this$[ebp]
	mov	al, BYTE PTR [eax+edx-65096]
	jmp	SHORT $LN26@Read8
	jmp	SHORT $LN22@Read8
$LN5@Read8:

; 70   : 	} else if (address >= 0xFF80 && address <= 0xFFFE) {
...
; 71   : 		return hram_[address-0xFF80];

	movzx	eax, WORD PTR _address$[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	mov	al, BYTE PTR [ecx+eax-65096]
	jmp	SHORT $LN26@Read8
	jmp	SHORT $LN22@Read8
$LN3@Read8:

; 72   : 	} else if (address == 0xFFFF) {

	movzx	edx, WORD PTR _address$[ebp]
	cmp	edx, 65535				; 0000ffffH
	jne	SHORT $LN22@Read8

; 73   : 		return interrupt_enable_register_;

	mov	eax, DWORD PTR _this$[ebp]
	mov	al, BYTE PTR [eax+439]
	jmp	SHORT $LN26@Read8
$LN22@Read8:
...
; 32   : 	eram_ = new uint8_t[0x2000];

	push	32					; 00000020H
	push	OFFSET $SG129275
	push	1
	push	8192					; 00002000H
	call	??_U@YAPAXIHPBDH@Z			; operator new[]
	add	esp, 16					; 00000010H
...
; 33   : 	wram1_ = new uint8_t[0x1000];

	push	33					; 00000021H
	push	OFFSET $SG129278
	push	1
	push	4096					; 00001000H
	call	??_U@YAPAXIHPBDH@Z			; operator new[]
	add	esp, 16					; 00000010H
...
; 34   : 	wram2_ = new uint8_t[0x1000];

	push	34					; 00000022H
	push	OFFSET $SG129281
	push	1
	push	4096					; 00001000H
	call	??_U@YAPAXIHPBDH@Z			; operator new[]
	add	esp, 16					; 00000010H
...
; 35   : 	ZeroMemory(ioports_,sizeof(ioports_));
...
; 82   :   const uint8_t* rom() { return rom_; }

...
CONST	ENDS
CONST	SEGMENT
$SG167114 DB	'Code\emulation\gb\cartridge.cpp', 00H
$SG167123 DB	'Code\emulation\gb\cartridge.cpp', 00H
$SG167127 DB	'Code\emulation\gb\cartridge.cpp', 00H
$SG167131 DB	'Code\emulation\gb\cartridge.cpp', 00H
$SG167135 DB	'Code\emulation\gb\cartridge.cpp', 00H
$SG167154 DB	'%s%s.ram', 00H
	ORG $+3
$SG167160 DB	'%s%s.ram', 00H
	ORG $+3
$SG167162 DB	'wb', 00H
	ORG $+1
...
; 118  : void Cartridge::Write(uint16_t address, uint8_t data) {
...
; 114  : uint8_t Cartridge::Read(uint16_t address) {
...
; 107  :   char filename[256*5];
; 108  :   sprintf(filename,"%s%s.ram",cartridge_path,cartridge_filename);
...
; 109  :   FILE* fp = fopen(filename,"wb");

	mov	esi, esp
	push	OFFSET $SG167162
...
; 110  :   fwrite(mbc->eram(),1,header->ram_size_bytes(),fp);
...
; 97   :   uint8_t* data=nullptr;

	mov	DWORD PTR _data$[ebp], 0

; 98   :   size_t length;
; 99   :   char filename[256*5];
; 100  :   sprintf(filename,"%s%s.ram",cartridge_path,cartridge_filename);
...
; 101  :   core::io::ReadWholeFileBinary(filename,&data,length);
...
; 103  :     memcpy(mbc->eram(),data,length);
...
; 47   :   uint8_t* data;
; 48   :   size_t length;
; 49   :   core::io::ReadWholeFileBinary(filename,&data,length);
...
; 50   :   memcpy(header,data+0x100,0x50);
...
; 54   :   }
; 55   :   rom_ = new uint8_t[header->rom_size_bytes()];

	push	55					; 00000037H
	push	OFFSET $SG167114
	push	1
	mov	ecx, DWORD PTR _header$[ebp]
	call	?rom_size_bytes@CartridgeHeader@gb@emulation@@QAEIXZ ; emulation::gb::CartridgeHeader::rom_size_bytes
	push	eax
...
; 56   :   memcpy(rom_,data,header->rom_size_bytes());
...
; 57   :   this->header = (CartridgeHeader*)&rom_[0x100];
...
; 58   : 
; 59   :   switch (header->cartridge_type) {

	mov	ecx, DWORD PTR _header$[ebp]
	movzx	edx, BYTE PTR [ecx+71]
	mov	DWORD PTR tv145[ebp], edx
	cmp	DWORD PTR tv145[ebp], 26		; 0000001aH
	ja	$LN1@LoadFile
	mov	eax, DWORD PTR tv145[ebp]
	movzx	ecx, BYTE PTR $LN20@LoadFile[eax]
	jmp	DWORD PTR $LN25@LoadFile[ecx*4]
$LN5@LoadFile:
...
; 83   : 
; 84   :   const char* a = strrchr(filename,'\\');
...
; 85   :   memset(cartridge_path,0,sizeof(cartridge_path));
...
; 86   :   strncpy(cartridge_path,filename,a-filename+1);
...
; 87   :   cartridge_path[a-filename+1] = '\0';

	mov	eax, DWORD PTR _a$[ebp]
	sub	eax, DWORD PTR _filename$[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	mov	BYTE PTR [ecx+eax+277], 0

; 88   :   strcpy(cartridge_filename,a+1);
...
; 91   :   core::io::DestroyFileBuffer(&data);
...
; 92   :   emu_->memory()->rom_ = emu_->cartridge()->rom();

...
_dmgrom	DB	031H
	...
	DB	0e0H
	DB	050H
$SG153681 DB	'Code\emulation\gb\memory.cpp', 00H
	ORG $+3
$SG153684 DB	'Code\emulation\gb\memory.cpp', 00H
	ORG $+3
$SG153687 DB	'Code\emulation\gb\memory.cpp', 00H
	ORG $+3
$SG153777 DB	'%c', 00H
	ORG $+1
...
EXTRN	?Write@SoundController@gb@emulation@@QAEXGE@Z:PROC ; emulation::gb::SoundController::Write

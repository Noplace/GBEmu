...
PUBLIC	?Reset@Timer@gb@emulation@@UAEXXZ		; emulation::gb::Timer::Reset
PUBLIC	?Tick@Timer@gb@emulation@@QAEXXZ		; emulation::gb::Timer::Tick
PUBLIC	?Check@Timer@gb@emulation@@QAEXXZ		; emulation::gb::Timer::Check
...
; 84   : void Timer::Write(uint16_t address, uint8_t data) {
...
; 98   :       case 0: tima_max = 4194304/4096 ; break;
...
; 99   :         case 1: tima_max = 4194304/262144; break;
...
; 100  :           case 2: tima_max = 4194304/65536 ; break;
...
; 101  :             case 3: tima_max = 4194304/16384 ; break;
...
; 68   : uint8_t Timer::Read(uint16_t address) {
...
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Check@Timer@gb@emulation@@QAEXXZ PROC			; emulation::gb::Timer::Check
; _this$ = ecx
...
; 65   : }
	...
	pop	ebp
	ret	0
?Check@Timer@gb@emulation@@QAEXXZ ENDP			; emulation::gb::Timer::Check
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\personal\projects\gbemu\solution\code\emulation\gb\timer.cpp
_TEXT	SEGMENT
...
; 53   :       emu_->memory()->interrupt_flag() |= 0x4;
...
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Reset@Timer@gb@emulation@@UAEXXZ PROC			; emulation::gb::Timer::Reset
; _this$ = ecx
...
; 42   : }
	...
	pop	ebp
	ret	0
?Reset@Timer@gb@emulation@@UAEXXZ ENDP			; emulation::gb::Timer::Reset
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\personal\projects\gbemu\solution\code\emulation\gb\timer.cpp
_TEXT	SEGMENT
...
; 26   : void Timer::Initialize(Emu* emu) {
...
; 28   : 	ioports = emu_->memory()->ioports();

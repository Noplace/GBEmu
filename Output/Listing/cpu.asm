...
PUBLIC	?apu@Emu@gb@emulation@@QAEPAVApu@23@XZ		; emulation::gb::Emu::apu
...
EXTRN	?Step@Apu@gb@emulation@@QAEXN@Z:PROC		; emulation::gb::Apu::Step
...
; 142  :   void arithmeticMode(uint8_t& a, uint8_t& b) {
...
; 148  :       b = mem_->Read8(reg.raw16[src]);
...
; 676  :       reg.raw8[reg_index[code&0x7]] = r;
...
; 667  :       return reg.raw8[reg_index[code&0x7]];
...
; 465  :   if (mode == 10) { //dest,d8

	xor	eax, eax
	je	SHORT $LN11@LD

; 466  : 		reg.raw8[dest] = mem_->Read8(reg.PC++);
...
; 467  : 	}else if (mode == 11) { //(dest),d8

	xor	edx, edx
	je	SHORT $LN9@LD

; 468  : 		auto d8 = mem_->Read8(reg.PC++);
...
; 469  : 		mem_->Write8(reg.raw16[dest],d8);
...
; 470  : 	} else if (mode == 12) { //0xFF00+d8 src

	xor	eax, eax
	je	SHORT $LN7@LD

; 471  :     uint8_t a8 = mem_->Read8(reg.PC++);
...
; 472  : 		mem_->Write8(0xFF00+a8,reg.raw8[src]);
...
; 473  : 	} else if (mode == 13) { //dest,0xFF00+d8 

	xor	ecx, ecx
	je	SHORT $LN5@LD

; 474  :     uint8_t a8 = mem_->Read8(reg.PC++);
...
; 475  : 		reg.raw8[dest] = mem_->Read8(0xFF00+a8);
...
; 476  : 	} else if (mode == 14) { //(d16),src

	xor	edx, edx
	je	$LN3@LD

; 477  : 		uint16_t d16 = mem_->Read8(reg.PC++);
...
; 479  :     mem_->Write8(d16,reg.raw8[src]);
...
; 480  : 	} else if (mode == 15) { //src,(d16)

	mov	ecx, 1
	test	ecx, ecx
	je	$LN12@LD

; 481  : 		uint16_t d16 = mem_->Read8(reg.PC++);
...
; 483  :     reg.raw8[dest] = mem_->Read8(d16);
...
; 629  :   arithmeticMode<dest,src,mode>(a,b);
...
; 631  :   updateCpuFlagZ(reg.raw8[dest]);
...
; 426  : 	reg.raw8[dest] = mem_->Read8(0xFF00+reg.raw8[src]);
...
; 930  :   simulateSpriteBug();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?simulateSpriteBug@Cpu@gb@emulation@@AAEXXZ ; emulation::gb::Cpu::simulateSpriteBug

; 931  :   reg.raw16[dest] = pop();
...
; 620  :   arithmeticMode<dest,src,mode>(a,b);
...
; 622  :   updateCpuFlagZ(reg.raw8[dest]);
...
; 609  :   arithmeticMode<dest,src,mode>(a,b);
...
; 612  :   updateCpuFlagZ(reg.raw8[dest]);
...
; 421  : 	mem_->Write8(0xFF00+reg.raw8[dest],reg.raw8[src]);
...
; 593  :   arithmeticMode<dest,src,mode>(a,b);
...
; 598  :     updateCpuFlagC(a-carry,b,1);
...
; 601  :     updateCpuFlagH(a-carry,b,1);
...
; 602  :   updateCpuFlagZ(reg.raw8[dest]);
...
; 888  :   int table[2] = {((reg.F.raw & (1<<condbit))>>condbit),
...
; 889  :     ~((reg.F.raw & (1<<condbit))>>condbit)};
...
; 859  :   int table[2] = {((reg.F.raw & (1<<condbit))>>condbit),
...
; 860  :     ~((reg.F.raw & (1<<condbit))>>condbit)};
...
; 908  :   int table[2] = {((reg.F.raw & (1<<condbit))>>condbit),
...
; 909  :     ~((reg.F.raw & (1<<condbit))>>condbit)};
...
; 582  :   arithmeticMode<dest,src,mode>(a,b);
...
; 586  :   updateCpuFlagZ(reg.raw8[dest]);
...
; 557  :   arithmeticMode<dest,src,mode>(a,b);
...
; 563  :     updateCpuFlagC(a+carry,b,0);
...
; 566  :     updateCpuFlagH(a+carry,b,0);
...
; 567  :   updateCpuFlagZ(reg.raw8[dest]);
...
; 520  :   arithmeticMode<dest,src,mode>(a,b);
...
; 524  :   updateCpuFlagZ(reg.raw8[dest]);
...
; 406  : 	reg.raw8[dest] = reg.raw8[src];
...
; 416  : 	reg.raw8[dest] = mem_->Read8(reg.raw16[src]);
...
; 411  : 	mem_->Write8(reg.raw16[dest],reg.raw8[src]);
...
; 818  :     //updateCpuFlagH(reg.raw8[dest],1,1);
; 819  :     --reg.raw8[dest];
...
; 824  :     updateCpuFlagZ(reg.raw8[dest]);
...
; 826  :     uint8_t data = mem_->Read8(reg.HL);
...
; 792  :     updateCpuFlagH(reg.raw8[dest],1,0);
...
; 794  :     updateCpuFlagZ(reg.raw8[dest]);
...
; 796  :     uint8_t data = mem_->Read8(reg.HL);
...
; 458  :   simulateSpriteBug();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?simulateSpriteBug@Cpu@gb@emulation@@AAEXXZ ; emulation::gb::Cpu::simulateSpriteBug

; 459  :   reg.raw8[dest] = mem_->Read8(reg.raw16[src]);
...
; 534  :   uint16_t r1 = (a&0xFFF) + (b&0xFFF);
...
; 536  :   uint32_t r2 = (a&0xFFFF) + (b&0xFFFF);
...
; 776  :   int table[2] = {((reg.F.raw & (1<<condbit))>>condbit),
...
; 777  :     ~((reg.F.raw & (1<<condbit))>>condbit)};
...
; 782  :     int8_t disp8 = mem_->Read8(reg.PC++);
...
; 445  : 	mem_->Write8(reg.raw16[dest],reg.raw8[src]);
...
; 431  : 	reg.raw16[dest] = mem_->Read8(reg.PC++);
...
; 432  : 	reg.raw16[dest] |= (mem_->Read8(reg.PC++))<<8;
...
; 433  :   if (dest != RegAF && (reg.raw16[dest]>=0xFE00&&reg.raw16[dest]<=0xFEFF) && emu_->lcd_driver()->lcdc().lcd_enable == 1)
...
; 451  :   simulateSpriteBug();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?simulateSpriteBug@Cpu@gb@emulation@@AAEXXZ ; emulation::gb::Cpu::simulateSpriteBug

; 452  :   reg.raw8[dest] = mem_->Read8(reg.raw16[src]);
...
; 439  : 	mem_->Write8(reg.raw16[dest],reg.raw8[src]);
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\khalid\documents\github\gbemu\solution\code\emulation\gb\emu.h
;	COMDAT ?apu@Emu@gb@emulation@@QAEPAVApu@23@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?apu@Emu@gb@emulation@@QAEPAVApu@23@XZ PROC		; emulation::gb::Emu::apu, COMDAT
; _this$ = ecx

; 45   : 	Apu* apu() { return &apu_; }
	...
	pop	ebp
	ret	0
?apu@Emu@gb@emulation@@QAEPAVApu@23@XZ ENDP		; emulation::gb::Emu::apu
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\khalid\documents\github\gbemu\solution\code\emulation\gb\emu.h
...
; 996  :   CP(reg.A,mem_->Read8(reg.HL));
...
; 992  :   CP(reg.A,mem_->Read8(reg.PC++));
...
; 979  : void Cpu::CP(uint8_t a, uint8_t b) {
...
; 769  : 	 int8_t disp8 = mem_->Read8(reg.PC++);
...
; 663  : 	uint8_t code = emu_->memory()->Read8(reg.PC++);
...
; 684  :     uint8_t bitshift = (code&0x38) >> 3;
...
; 685  :     reg.F.Z = (~(((test&(1<<bitshift))>>bitshift))&0x1);
...
; 688  : 
; 689  :   } else if ((code & 0xC0) == 0x80) { //res
...
; 690  :     uint8_t test = getr();

	lea	ecx, DWORD PTR _getr$[ebp]
	call	??R<lambda_cf4d431a50c7ddf749029b7e3fcc8a53>@@QBEEXZ ; <lambda_cf4d431a50c7ddf749029b7e3fcc8a53>::operator()
	mov	BYTE PTR _test$16[ebp], al

; 691  :     uint8_t bitshift = (code&0x38) >> 3;
...
; 694  :   } else if ((code & 0xC0) == 0xC0) { //set
...
; 695  :     uint8_t test = getr();

	lea	ecx, DWORD PTR _getr$[ebp]
	call	??R<lambda_cf4d431a50c7ddf749029b7e3fcc8a53>@@QBEEXZ ; <lambda_cf4d431a50c7ddf749029b7e3fcc8a53>::operator()
	mov	BYTE PTR _test$14[ebp], al

; 696  :     uint8_t bitshift = (code&0x38) >> 3;
...
; 699  :   } else  if ((code & 0xF8) == 0x30) { //swap
...
; 715  :   } else if ((code&0xF8) == 0x08) { //RRC r
...
; 723  :   } else if ((code&0xF8) == 0x10) { //RL r
...
; 732  :   } else if ((code&0xF8) == 0x18) { //RR r
...
; 741  : 
; 742  :   } else if ((code&0xF8) == 0x20) { //SLA r
...
; 750  :   } else if ((code&0xF8) == 0x28) { //SRA r
...
; 757  :   } else if ((code & 0xF8) == 0x38) { //SRL n
...
; 543  : 	uint16_t a = reg.SP;

	mov	eax, DWORD PTR _this$[ebp]
	mov	cx, WORD PTR [eax+1072]
	mov	WORD PTR _a$[ebp], cx

; 544  : 	int8_t r8 = mem_->Read8(reg.PC++);
...
; 546  : 
; 547  :   updateCpuFlagC(a&0xFF,r8,0);
...
; 548  :   updateCpuFlagH(a&0xFF,r8,0);
...
; 510  :   uint16_t a16 = mem_->Read8(reg.PC++);
...
; 512  :   mem_->Write8(a16,reg.SP&0xFF);
...
; 513  :   mem_->Write8(a16+1,reg.SP>>8);
...
; 497  : 	uint16_t a = reg.SP;

	mov	eax, DWORD PTR _this$[ebp]
	mov	cx, WORD PTR [eax+1072]
	mov	WORD PTR _a$[ebp], cx

; 498  : 	int8_t r8 = mem_->Read8(reg.PC++);
...
; 500  :   updateCpuFlagC(a&0xFF,r8,0);
...
; 501  :   updateCpuFlagH(a&0xFF,r8,0);
...
; 502  :   /*uint16_t r1 = (a&0xFFF) + (r8&0xFFF);
; 503  :   reg.F.H = r1>0xFFF?1:0;
; 504  :   uint32_t r2 = (a&0xFFFF) + (r8&0xFFFF);
; 505  :   reg.F.C = r2>0xFFFF?1:0;*/
; 506  : 	Tick();Tick();Tick();Tick();
...
; 129  :   void updateCpuFlagZ(uint8_t r) {
...
; 116  :   void updateCpuFlagH(uint8_t a,uint8_t b,int mode) {
...
; 107  :   void updateCpuFlagC(uint8_t a,uint8_t b,int mode) {
...
; 1042 : void Cpu::simulateSpriteBug() {
...
; 1045 :     emu_->lcd_driver()->sprite_bug_counter = 80;//20cycles
...
; 1046 :     //auto oam = emu_->memory()->oam();
; 1047 :     //for (int i=8;i<0xA0;++i)
; 1048 :     //  oam[i] = rand()&0xFF;
; 1049 :     sprite_bug = 0;
...
; 344  :   //reg.F._unused = 0;//always 0 according to docs
; 345  :   //StopAt(0xC47A);
; 346  :   //StopAt(0x0100);
; 347  :   //StopAt(0x0073);
; 348  :   if (cpumode_ == CpuModeStop) {
...
; 351  :   }
; 352  :   if (cpumode_ == CpuModeNormal) {

	mov	ecx, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [ecx+24], 0
	jne	$LN15@Step

; 353  :     if (sprite_bug!=0) --sprite_bug;
...
; 354  :     opcode = emu_->memory()->Read8(reg.PC++);
...
; 356  :   } else if (cpumode_ == CpuModeHalt) {
...
; 361  :     uint8_t test = emu_->memory()->interrupt_enable() & emu_->memory()->interrupt_flag();
...
; 368  : 				emu_->memory()->interrupt_flag() &= ~0x1;
...
; 369  : 			} else if (test & 0x2) {

	movzx	ecx, BYTE PTR _test$1[ebp]
	and	ecx, 2
	je	SHORT $LN7@Step

; 370  : 				reg.PC = 0x0048; //lcdc status

	mov	edx, 72					; 00000048H
	mov	eax, DWORD PTR _this$[ebp]
	mov	WORD PTR [eax+1074], dx

; 371  : 				emu_->memory()->interrupt_flag() &= ~0x2;
...
; 372  : 			} else if (test & 0x4) {

	movzx	edx, BYTE PTR _test$1[ebp]
	and	edx, 4
	je	SHORT $LN5@Step

; 373  : 				reg.PC = 0x0050; //timer overflow

	mov	eax, 80					; 00000050H
	mov	ecx, DWORD PTR _this$[ebp]
	mov	WORD PTR [ecx+1074], ax

; 374  : 				emu_->memory()->interrupt_flag() &= ~0x4;
...
; 375  : 			} else if (test & 0x8) {

	movzx	eax, BYTE PTR _test$1[ebp]
	and	eax, 8
	je	SHORT $LN3@Step

; 376  : 				reg.PC = 0x0058; //serial transfer

	mov	ecx, 88					; 00000058H
	mov	edx, DWORD PTR _this$[ebp]
	mov	WORD PTR [edx+1074], cx

; 377  : 				emu_->memory()->interrupt_flag() &= ~0x8;
...
; 378  : 			} else if (test & 0x10) {

	movzx	ecx, BYTE PTR _test$1[ebp]
	and	ecx, 16					; 00000010H
	je	SHORT $LN1@Step

; 379  : 				reg.PC = 0x0060; //hi-lo p10-p13

	mov	edx, 96					; 00000060H
	mov	eax, DWORD PTR _this$[ebp]
	mov	WORD PTR [eax+1074], dx

; 380  : 				emu_->memory()->interrupt_flag() &= ~0x10;
...
; 337  : 	emu_->apu()->Step(dt);
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [edx+4]
	call	?apu@Emu@gb@emulation@@QAEPAVApu@23@XZ	; emulation::gb::Emu::apu
	mov	ecx, eax
	call	?Step@Apu@gb@emulation@@QAEXN@Z		; emulation::gb::Apu::Step
...
; 312  : void Cpu::Initialize(Emu* emu) {
...
; 35   : 	instructions[0x01] = &Cpu::LDrd16<RegBC>;
...
; 36   : 	instructions[0x02] = &Cpu::LD$rr<RegBC,RegA>;
...
; 37   : 	instructions[0x03] = &Cpu::INC_16bit<RegBC>;
...
; 38   : 	instructions[0x04] = &Cpu::INC_8bit<RegB,0>;
...
; 39   : 	instructions[0x05] = &Cpu::DEC_8bit<RegB,0>;
...
; 40   : 	instructions[0x06] = &Cpu::LD<RegB,0,10>;
...
; 42   : 	instructions[0x08] = &Cpu::LDa16SP;
...
; 43   : 	instructions[0x09] = &Cpu::ADD_16bit<RegHL,RegBC>;
...
; 44   : 	instructions[0x0A] = &Cpu::LDr$r<RegA,RegBC>;
...
; 45   : 	instructions[0x0B] = &Cpu::DEC_16bit<RegBC>;
...
; 46   : 	instructions[0x0C] = &Cpu::INC_8bit<RegC,0>;
...
; 47   : 	instructions[0x0D] = &Cpu::DEC_8bit<RegC,0>;
...
; 48   : 	instructions[0x0E] = &Cpu::LD<RegC,0,10>;
...
; 52   : 	instructions[0x11] = &Cpu::LDrd16<RegDE>;
...
; 53   : 	instructions[0x12] = &Cpu::LD$rr<RegDE,RegA>;
...
; 54   : 	instructions[0x13] = &Cpu::INC_16bit<RegDE>;
...
; 55   : 	instructions[0x14] = &Cpu::INC_8bit<RegD,0>;
...
; 56   : 	instructions[0x15] = &Cpu::DEC_8bit<RegD,0>;
...
; 57   : 	instructions[0x16] = &Cpu::LD<RegD,0,10>;
...
; 60   : 	instructions[0x19] = &Cpu::ADD_16bit<RegHL,RegDE>;
...
; 61   : 	instructions[0x1A] = &Cpu::LDr$r<RegA,RegDE>;
...
; 62   : 	instructions[0x1B] = &Cpu::DEC_16bit<RegDE>;
...
; 63   : 	instructions[0x1C] = &Cpu::INC_8bit<RegE,0>;
...
; 64   : 	instructions[0x1D] = &Cpu::DEC_8bit<RegE,0>;
...
; 65   : 	instructions[0x1E] = &Cpu::LD<RegE,0,10>;
...
; 67   : 	
; 68   : 	instructions[0x20] = &Cpu::JR_cc<CpuFlagsZ,1>;
...
; 69   : 	instructions[0x21] = &Cpu::LDrd16<RegHL>;
...
; 70   : 	instructions[0x22] = &Cpu::LDI$regreg<RegHL,RegA>;
...
; 71   : 	instructions[0x23] = &Cpu::INC_16bit<RegHL>;
...
; 72   : 	instructions[0x24] = &Cpu::INC_8bit<RegH,0>;
...
; 73   : 	instructions[0x25] = &Cpu::DEC_8bit<RegH,0>;
...
; 74   : 	instructions[0x26] = &Cpu::LD<RegH,0,10>;
...
; 76   : 	instructions[0x28] = &Cpu::JR_cc<CpuFlagsZ,0>;
...
; 77   : 	instructions[0x29] = &Cpu::ADD_16bit<RegHL,RegHL>;
...
; 78   : 	instructions[0x2A] = &Cpu::LDIreg$reg<RegA,RegHL>;
...
; 79   : 	instructions[0x2B] = &Cpu::DEC_16bit<RegHL>;
...
; 80   : 	instructions[0x2C] = &Cpu::INC_8bit<RegL,0>;
...
; 81   : 	instructions[0x2D] = &Cpu::DEC_8bit<RegL,0>;
...
; 82   : 	instructions[0x2E] = &Cpu::LD<RegL,0,10>;
...
; 84   : 
; 85   : 	instructions[0x30] = &Cpu::JR_cc<CpuFlagsC,1>;
...
; 86   : 	instructions[0x31] = &Cpu::LDrd16<RegSP>;
...
; 87   : 	instructions[0x32] = &Cpu::LDD$regreg<RegHL,RegA>;
...
; 88   : 	instructions[0x33] = &Cpu::INC_16bit<RegSP>;
...
; 89   : 	instructions[0x34] = &Cpu::INC_8bit<RegHL,1>;
...
; 90   : 	instructions[0x35] = &Cpu::DEC_8bit<RegHL,1>;
...
; 91   : 	instructions[0x36] = &Cpu::LD<RegHL,0,11>;
...
; 93   : 	instructions[0x38] = &Cpu::JR_cc<CpuFlagsC,0>;
...
; 94   : 	instructions[0x39] = &Cpu::ADD_16bit<RegHL,RegSP>;
...
; 95   : 	instructions[0x3A] = &Cpu::LDDreg$reg<RegA,RegHL>;
...
; 96   : 	instructions[0x3B] = &Cpu::DEC_16bit<RegSP>;
...
; 97   : 	instructions[0x3C] = &Cpu::INC_8bit<RegA,0>;
...
; 98   : 	instructions[0x3D] = &Cpu::DEC_8bit<RegA,0>;
...
; 99   : 	instructions[0x3E] = &Cpu::LD<RegA,0,10>;
...
; 101  : 
; 102  : 	instructions[0x40] = &Cpu::LDrr<RegB,RegB>;
...
; 103  : 	instructions[0x41] = &Cpu::LDrr<RegB,RegC>;
...
; 104  : 	instructions[0x42] = &Cpu::LDrr<RegB,RegD>;
...
; 105  : 	instructions[0x43] = &Cpu::LDrr<RegB,RegE>;
...
; 106  : 	instructions[0x44] = &Cpu::LDrr<RegB,RegH>;
...
; 107  : 	instructions[0x45] = &Cpu::LDrr<RegB,RegL>;
...
; 108  : 	instructions[0x46] = &Cpu::LDr$r<RegB,RegHL>;
...
; 109  : 	instructions[0x47] = &Cpu::LDrr<RegB,RegA>;
...
; 110  : 	instructions[0x48] = &Cpu::LDrr<RegC,RegB>;
...
; 111  : 	instructions[0x49] = &Cpu::LDrr<RegC,RegC>;
...
; 112  : 	instructions[0x4A] = &Cpu::LDrr<RegC,RegD>;
...
; 113  : 	instructions[0x4B] = &Cpu::LDrr<RegC,RegE>;
...
; 114  : 	instructions[0x4C] = &Cpu::LDrr<RegC,RegH>;
...
; 115  : 	instructions[0x4D] = &Cpu::LDrr<RegC,RegL>;
...
; 116  : 	instructions[0x4E] = &Cpu::LDr$r<RegC,RegHL>;
...
; 117  : 	instructions[0x4F] = &Cpu::LDrr<RegC,RegA>;
...
; 118  : 
; 119  : 	instructions[0x50] = &Cpu::LDrr<RegD,RegB>;
...
; 120  : 	instructions[0x51] = &Cpu::LDrr<RegD,RegC>;
...
; 121  : 	instructions[0x52] = &Cpu::LDrr<RegD,RegD>;
...
; 122  : 	instructions[0x53] = &Cpu::LDrr<RegD,RegE>;
...
; 123  : 	instructions[0x54] = &Cpu::LDrr<RegD,RegH>;
...
; 124  : 	instructions[0x55] = &Cpu::LDrr<RegD,RegL>;
...
; 125  : 	instructions[0x56] = &Cpu::LDr$r<RegD,RegHL>;
...
; 126  : 	instructions[0x57] = &Cpu::LDrr<RegD,RegA>;
...
; 127  : 	instructions[0x58] = &Cpu::LDrr<RegE,RegB>;
...
; 128  : 	instructions[0x59] = &Cpu::LDrr<RegE,RegC>;
...
; 129  : 	instructions[0x5A] = &Cpu::LDrr<RegE,RegD>;
...
; 130  : 	instructions[0x5B] = &Cpu::LDrr<RegE,RegE>;
...
; 131  : 	instructions[0x5C] = &Cpu::LDrr<RegE,RegH>;
...
; 132  : 	instructions[0x5D] = &Cpu::LDrr<RegE,RegL>;
...
; 133  : 	instructions[0x5E] = &Cpu::LDr$r<RegE,RegHL>;
...
; 134  : 	instructions[0x5F] = &Cpu::LDrr<RegE,RegA>;
...
; 135  : 
; 136  : 	instructions[0x60] = &Cpu::LDrr<RegH,RegB>;
...
; 137  : 	instructions[0x61] = &Cpu::LDrr<RegH,RegC>;
...
; 138  : 	instructions[0x62] = &Cpu::LDrr<RegH,RegD>;
...
; 139  : 	instructions[0x63] = &Cpu::LDrr<RegH,RegE>;
...
; 140  : 	instructions[0x64] = &Cpu::LDrr<RegH,RegH>;
...
; 141  : 	instructions[0x65] = &Cpu::LDrr<RegH,RegL>;
...
; 142  : 	instructions[0x66] = &Cpu::LDr$r<RegH,RegHL>;
...
; 143  : 	instructions[0x67] = &Cpu::LDrr<RegH,RegA>;
...
; 144  : 	instructions[0x68] = &Cpu::LDrr<RegL,RegB>;
...
; 145  : 	instructions[0x69] = &Cpu::LDrr<RegL,RegC>;
...
; 146  : 	instructions[0x6A] = &Cpu::LDrr<RegL,RegD>;
...
; 147  : 	instructions[0x6B] = &Cpu::LDrr<RegL,RegE>;
...
; 148  : 	instructions[0x6C] = &Cpu::LDrr<RegL,RegH>;
...
; 149  : 	instructions[0x6D] = &Cpu::LDrr<RegL,RegL>;
...
; 150  : 	instructions[0x6E] = &Cpu::LDr$r<RegL,RegHL>;
...
; 151  : 	instructions[0x6F] = &Cpu::LDrr<RegL,RegA>;
...
; 152  : 
; 153  : 	instructions[0x70] = &Cpu::LD$rr<RegHL,RegB>;
...
; 154  : 	instructions[0x71] = &Cpu::LD$rr<RegHL,RegC>;
...
; 155  : 	instructions[0x72] = &Cpu::LD$rr<RegHL,RegD>;
...
; 156  : 	instructions[0x73] = &Cpu::LD$rr<RegHL,RegE>;
...
; 157  : 	instructions[0x74] = &Cpu::LD$rr<RegHL,RegH>;
...
; 158  : 	instructions[0x75] = &Cpu::LD$rr<RegHL,RegL>;
...
; 159  : 	instructions[0x76] = &Cpu::HALT;
...
; 160  : 	instructions[0x77] = &Cpu::LD$rr<RegHL,RegA>;
...
; 161  : 	instructions[0x78] = &Cpu::LDrr<RegA,RegB>;
...
; 162  : 	instructions[0x79] = &Cpu::LDrr<RegA,RegC>;
...
; 163  : 	instructions[0x7A] = &Cpu::LDrr<RegA,RegD>;
...
; 164  : 	instructions[0x7B] = &Cpu::LDrr<RegA,RegE>;
...
; 165  : 	instructions[0x7C] = &Cpu::LDrr<RegA,RegH>;
...
; 166  : 	instructions[0x7D] = &Cpu::LDrr<RegA,RegL>;
...
; 167  : 	instructions[0x7E] = &Cpu::LDr$r<RegA,RegHL>;
...
; 168  : 	instructions[0x7F] = &Cpu::LDrr<RegA,RegA>;
...
; 169  : 
; 170  : 	instructions[0x80] = &Cpu::ADD<RegA,RegB,0>;
...
; 171  : 	instructions[0x81] = &Cpu::ADD<RegA,RegC,0>;
...
; 172  : 	instructions[0x82] = &Cpu::ADD<RegA,RegD,0>;
...
; 173  : 	instructions[0x83] = &Cpu::ADD<RegA,RegE,0>;
...
; 174  : 	instructions[0x84] = &Cpu::ADD<RegA,RegH,0>;
...
; 175  : 	instructions[0x85] = &Cpu::ADD<RegA,RegL,0>;
...
; 176  : 	instructions[0x86] = &Cpu::ADD<RegA,RegHL,1>;
...
; 177  : 	instructions[0x87] = &Cpu::ADD<RegA,RegA,0>;
...
; 178  : 	instructions[0x88] = &Cpu::ADC<RegA,RegB,0>;
...
; 179  : 	instructions[0x89] = &Cpu::ADC<RegA,RegC,0>;
...
; 180  : 	instructions[0x8A] = &Cpu::ADC<RegA,RegD,0>;
...
; 181  : 	instructions[0x8B] = &Cpu::ADC<RegA,RegE,0>;
...
; 182  : 	instructions[0x8C] = &Cpu::ADC<RegA,RegH,0>;
...
; 183  : 	instructions[0x8D] = &Cpu::ADC<RegA,RegL,0>;
...
; 184  : 	instructions[0x8E] = &Cpu::ADC<RegA,RegHL,1>;
...
; 185  : 	instructions[0x8F] = &Cpu::ADC<RegA,RegA,0>;
...
; 186  : 
; 187  : 	instructions[0x90] = &Cpu::SUB<RegA,RegB,0>;
...
; 188  : 	instructions[0x91] = &Cpu::SUB<RegA,RegC,0>;
...
; 189  : 	instructions[0x92] = &Cpu::SUB<RegA,RegD,0>;
...
; 190  : 	instructions[0x93] = &Cpu::SUB<RegA,RegE,0>;
...
; 191  : 	instructions[0x94] = &Cpu::SUB<RegA,RegH,0>;
...
; 192  : 	instructions[0x95] = &Cpu::SUB<RegA,RegL,0>;
...
; 193  : 	instructions[0x96] = &Cpu::SUB<RegA,RegHL,1>;
...
; 194  : 	instructions[0x97] = &Cpu::SUB<RegA,RegA,0>;
...
; 195  : 	instructions[0x98] = &Cpu::SBC<RegA,RegB,0>;
...
; 196  : 	instructions[0x99] = &Cpu::SBC<RegA,RegC,0>;
...
; 197  : 	instructions[0x9A] = &Cpu::SBC<RegA,RegD,0>;
...
; 198  : 	instructions[0x9B] = &Cpu::SBC<RegA,RegE,0>;
...
; 199  : 	instructions[0x9C] = &Cpu::SBC<RegA,RegH,0>;
...
; 200  : 	instructions[0x9D] = &Cpu::SBC<RegA,RegL,0>;
...
; 201  : 	instructions[0x9E] = &Cpu::SBC<RegA,RegHL,1>;
...
; 202  : 	instructions[0x9F] = &Cpu::SBC<RegA,RegA,0>;
...
; 203  : 
; 204  : 	instructions[0xA0] = &Cpu::AND<RegA,RegB,0>;
...
; 205  : 	instructions[0xA1] = &Cpu::AND<RegA,RegC,0>;
...
; 206  : 	instructions[0xA2] = &Cpu::AND<RegA,RegD,0>;
...
; 207  : 	instructions[0xA3] = &Cpu::AND<RegA,RegE,0>;
...
; 208  : 	instructions[0xA4] = &Cpu::AND<RegA,RegH,0>;
...
; 209  : 	instructions[0xA5] = &Cpu::AND<RegA,RegL,0>;
...
; 210  : 	instructions[0xA6] = &Cpu::AND<RegA,RegHL,1>;
...
; 211  : 	instructions[0xA7] = &Cpu::AND<RegA,RegA,0>;
...
; 212  : 	instructions[0xA8] = &Cpu::XOR<RegA,RegB,0>;
...
; 213  : 	instructions[0xA9] = &Cpu::XOR<RegA,RegC,0>;
...
; 214  : 	instructions[0xAA] = &Cpu::XOR<RegA,RegD,0>;
...
; 215  : 	instructions[0xAB] = &Cpu::XOR<RegA,RegE,0>;
...
; 216  : 	instructions[0xAC] = &Cpu::XOR<RegA,RegH,0>;
...
; 217  : 	instructions[0xAD] = &Cpu::XOR<RegA,RegL,0>;
...
; 218  : 	instructions[0xAE] = &Cpu::XOR<RegA,RegHL,1>;
...
; 219  : 	instructions[0xAF] = &Cpu::XOR<RegA,RegA,0>;
...
; 220  : 
; 221  : 	instructions[0xB0] = &Cpu::OR<RegA,RegB,0>;
...
; 222  : 	instructions[0xB1] = &Cpu::OR<RegA,RegC,0>;
...
; 223  : 	instructions[0xB2] = &Cpu::OR<RegA,RegD,0>;
...
; 224  : 	instructions[0xB3] = &Cpu::OR<RegA,RegE,0>;
...
; 225  : 	instructions[0xB4] = &Cpu::OR<RegA,RegH,0>;
...
; 226  : 	instructions[0xB5] = &Cpu::OR<RegA,RegL,0>;
...
; 227  : 	instructions[0xB6] = &Cpu::OR<RegA,RegHL,1>;
...
; 228  : 	instructions[0xB7] = &Cpu::OR<RegA,RegA,0>;
...
; 229  :   instructions[0xB8] = &Cpu::CP_reg<RegB>;
...
; 230  :   instructions[0xB9] = &Cpu::CP_reg<RegC>;
...
; 231  :   instructions[0xBA] = &Cpu::CP_reg<RegD>;
...
; 232  :   instructions[0xBB] = &Cpu::CP_reg<RegE>;
...
; 233  :   instructions[0xBC] = &Cpu::CP_reg<RegH>;
...
; 234  :   instructions[0xBD] = &Cpu::CP_reg<RegL>;
...
; 235  :   instructions[0xBE] = &Cpu::CP_HL;
...
; 236  :   instructions[0xBF] = &Cpu::CP_reg<RegA>;
...
; 237  : 	
; 238  : 	instructions[0xC0] = &Cpu::RET_cc<CpuFlagsZ,1>;
...
; 239  : 	instructions[0xC1] = &Cpu::POP<RegBC>;
...
; 240  : 	instructions[0xC2] = &Cpu::JP_cc<CpuFlagsZ,1>;
...
; 242  : 	instructions[0xC4] = &Cpu::CALL_cc<CpuFlagsZ,1>;
...
; 243  : 	instructions[0xC5] = &Cpu::PUSH<RegBC>;
...
; 244  :   instructions[0xC6] = &Cpu::ADD<RegA,0,2>;
...
; 246  : 	instructions[0xC8] = &Cpu::RET_cc<CpuFlagsZ,0>;
...
; 248  : 	instructions[0xCA] = &Cpu::JP_cc<CpuFlagsZ,0>;
...
; 249  : 	instructions[0xCB] = &Cpu::PREFIX_CB;
...
; 251  : 	instructions[0xCD] = &Cpu::CALL;
...
; 252  : 	instructions[0xCE] = &Cpu::ADC<RegA,0,2>;
...
; 254  : 
; 255  : 	instructions[0xD0] = &Cpu::RET_cc<CpuFlagsC,1>;
...
; 256  : 	instructions[0xD1] = &Cpu::POP<RegDE>;
...
; 257  : 	instructions[0xD2] = &Cpu::JP_cc<CpuFlagsC,1>;
...
; 258  : 	instructions[0xD3] = &Cpu::ILLEGAL;
...
; 259  : 	instructions[0xD4] = &Cpu::CALL_cc<CpuFlagsC,1>;
...
; 260  : 	instructions[0xD5] = &Cpu::PUSH<RegDE>;
...
; 261  :   instructions[0xD6] = &Cpu::SUB<RegA,0,2>;
...
; 263  : 	instructions[0xD8] = &Cpu::RET_cc<CpuFlagsC,0>;
...
; 264  : 	instructions[0xD9] = &Cpu::RETI;
...
; 265  : 	instructions[0xDA] = &Cpu::JP_cc<CpuFlagsC,0>;
...
; 266  : 	instructions[0xDB] = &Cpu::ILLEGAL;
...
; 267  : 	instructions[0xDC] = &Cpu::CALL_cc<CpuFlagsC,0>;
...
; 268  : 	instructions[0xDD] = &Cpu::ILLEGAL;
...
; 269  : 	instructions[0xDE] = &Cpu::SBC<RegA,0,2>;
...
; 271  : 	
; 272  : 	instructions[0xE0] = &Cpu::LD<0,RegA,12>;
...
; 273  : 	instructions[0xE1] = &Cpu::POP<RegHL>;
...
; 274  : 	instructions[0xE2] = &Cpu::LD$FF00rr<RegC,RegA>;
...
; 275  : 	instructions[0xE3] = &Cpu::ILLEGAL;
...
; 276  : 	instructions[0xE4] = &Cpu::ILLEGAL;
...
; 277  : 	instructions[0xE5] = &Cpu::PUSH<RegHL>;
...
; 278  :   instructions[0xE6] = &Cpu::AND<RegA,0,2>;
...
; 280  : 	instructions[0xE8] = &Cpu::ADD_SPr8;
...
; 281  : 	instructions[0xE9] = &Cpu::JP_HL;
...
; 282  : 	instructions[0xEA] = &Cpu::LD<0,RegA,14>;
...
; 283  : 	instructions[0xEB] = &Cpu::ILLEGAL;
...
; 284  : 	instructions[0xEC] = &Cpu::ILLEGAL;
...
; 285  : 	instructions[0xED] = &Cpu::ILLEGAL;
...
; 286  : 	instructions[0xEE] = &Cpu::XOR<RegA,0,2>;
...
; 288  : 
; 289  : 	instructions[0xF0] = &Cpu::LD<RegA,0,13>;
...
; 290  : 	instructions[0xF1] = &Cpu::POP<RegAF>;
...
; 291  : 	instructions[0xF2] = &Cpu::LDr$FF00r<RegA,RegC>;
...
; 293  : 	instructions[0xF4] = &Cpu::ILLEGAL;
...
; 294  : 	instructions[0xF5] = &Cpu::PUSH<RegAF>;
...
; 295  :   instructions[0xF6] = &Cpu::OR<RegA,0,2>;
...
; 297  : 	instructions[0xF8] = &Cpu::LDHLSPr8;
...
; 298  : 	instructions[0xF9] = &Cpu::LDSPHL;
...
; 299  : 	instructions[0xFA] = &Cpu::LD<RegA,0,15>;
...
; 301  : 	instructions[0xFC] = &Cpu::ILLEGAL;
...
; 302  : 	instructions[0xFD] = &Cpu::ILLEGAL;
...
; 303  : 	instructions[0xFE] = &Cpu::CP_d8;
...
; 71   : 	const LCDControlRegister& lcdc() { return lcdc_; }
...
; 40   :   uint8_t& interrupt_enable() { return interrupt_enable_register_; }

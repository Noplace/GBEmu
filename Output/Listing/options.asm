...
; 86   : INT_PTR CALLBACK Options::DialogProc(__in  HWND hwndDlg,__in  UINT uMsg,__in  WPARAM wParam,__in  LPARAM lParam) {
...
; 87   :   
; 88   :   Options* self = nullptr;

	mov	DWORD PTR _self$[ebp], 0

; 89   :   if (uMsg == WM_INITDIALOG) {

	cmp	DWORD PTR _uMsg$[ebp], 272		; 00000110H
	jne	SHORT $LN11@DialogProc

; 90   :     SetWindowLongPtr(hwndDlg,DWLP_USER,lParam);
...
; 91   :     self = reinterpret_cast<Options*>(lParam);
...
; 94   :   }
; 95   :   self = reinterpret_cast<Options*>(GetWindowLongPtr(hwndDlg,DWLP_USER));
...
; 107  :     case WM_HSCROLL:{
; 108  :         auto slider1 = GetDlgItem(hwndDlg,IDC_SLIDER1);
...
; 123  :         EndDialog(hwndDlg,self->create_result);
...
; 82   : void Options::copy_from_volatile() {
...
; 78   : void Options::copy_to_volatile() {
...
; 72   : void Options::set_cpu_freq_text(double cpu_freq) {
...
; 73   :   char str[25];
; 74   :   sprintf(str,"%0.2f Mhz",cpu_freq*0.000001);
...
; 75   :   SetDlgItemText(handle_,IDC_FREQ_LABEL,str);
...
; 55   : void Options::OnInit(HWND hwndDlg) {
...
; 57   :   auto slider1 = GetDlgItem(hwndDlg,IDC_SLIDER1);
...
; 62   : 
; 63   : //  set_cpu_freq_text(nes_settings_volatile.cpu_freq_hz);
; 64   :   WPARAM value = 0;//convertRange<WPARAM>(CPU_MIN_FREQ,CPU_MAX_FREQ,0.0,100.0,nes_settings_volatile.cpu_freq_hz);

	mov	DWORD PTR _value$[ebp], 0

; 65   :   SendDlgItemMessage(handle_,IDC_SLIDER1,TBM_SETRANGEMIN,1,(LPARAM)0);
...
; 66   :   SendDlgItemMessage(handle_,IDC_SLIDER1,TBM_SETRANGEMAX,1,(LPARAM)100);
...
; 67   :   SendDlgItemMessage(handle_,IDC_SLIDER1,TBM_SETPOS,1,(LPARAM)value);
...
; 41   : void Options::Show(core::windows::Window* parent) {
...
; 46   :   }
; 47   :    
; 48   :   create_result = DialogBoxParam(GetModuleHandle(nullptr),MAKEINTRESOURCE(IDD_OPTIONS),parenthWnd,DialogProc,(LPARAM)this);
...
; 33   : Options::Options() : init_(false) {

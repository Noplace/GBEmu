...
; 36   :   //unsigned old_fp_state;
; 37   :   //_controlfp_s(&old_fp_state, _PC_53, _MCW_PC);
; 38   : 
; 39   :   display_window_.Init();
...
; 46   :     } else {
; 47   :       //display_window_.Step(); 
; 48   :     }
; 49   :   } while(msg.message!=WM_QUIT && display_window_.exit_signal() == false);
...
; 50   : 
; 51   :  //CoUninitialize();
; 52   :  //Return the exit code to the system. 
; 53   :  return static_cast<int>(msg.wParam);
...
; 25   : Application::Application(HINSTANCE instance , LPSTR command_line, int show_command) {
...
; 26   :   //OleInitialize(NULL);
; 27   :   current_app_ = this;
...
; 35   :     bool exit_signal() { return exit_signal_; }
